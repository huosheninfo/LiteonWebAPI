...
{	
	...
	public class Account__do {
		...
		public static JSONObject queryAccount_class(JSONObject paramsObject, ActionContext context){
		...
		public static JSONObject saveAccount_class(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
		...
		public static JSONObject queryAccount(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
		...
		public static JSONObject saveAccount(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
