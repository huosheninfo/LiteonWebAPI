...
{	
	...
	public class Weixin__do {
		...
		public static JSONObject service(JSONObject paramsObject, ActionContext context){
			...
			try
            {		
				var ret =  weixin.Service.service(paramsObject, context);
			    if (selfContext)
                {
                    context.commit();
                }
		...
		public static JSONObject jsapi(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
			...
			try
            {		
				var ret =  weixin.WxMpJsApi.service(paramsObject, context);
			    if (selfContext)
                {
                    context.commit();
                }
		...
		public static JSONObject notify(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
			...
			try
            {		
				var ret =  weixin.WxPayNotify.service(paramsObject, context);
			    if (selfContext)
                {
                    context.commit();
                }
		...
		public static JSONObject userinfo(JSONObject paramsObject, ActionContext context){
			bool selfContext = null == context;
			if (selfContext)
		    {
		        context = new ActionContext(DbConfig);
			...
			try
            {		
				var ret =  weixin.UserInfo.service(paramsObject, context);
			    if (selfContext)
                {
                    context.commit();
                }
