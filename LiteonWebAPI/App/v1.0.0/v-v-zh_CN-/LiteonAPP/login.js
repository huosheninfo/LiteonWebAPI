define(function(require) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data.ResponseState == "1") {
					justep.Util.addCookie("userid", data.ResponseData.UserID, "/", "164");
	...
	Model.prototype.modelLoad = function(event) {
		...
		$('#' + this.getIDByXID("div5")).html(
				'<a href="bdapp://map/show?center=40.057406655722,116.29644071728&zoom=11&traffic=on&bounds=37.8608310000,112.5963090000,42.1942670000,118.9491260000">展示地图</a>');
